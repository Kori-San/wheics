...
export default function PagesJaunesTool({ name, address }) {
    ...
    return (
        <a
            ...
            target="_blank"
            className="h-16 max-w-80 group transition-all duration-200 ease-in-out hover:scale-105 hover:bg-amber-500 rounded bg-yellow-500 flex flex-row items-center justify-center gap-1"
        >
