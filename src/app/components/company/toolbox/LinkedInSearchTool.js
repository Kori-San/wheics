...
export default function LinkedInSearchTool({ term }) {
    return (
        <a
            className="min-w-36 h-16 max-w-52 bg-blue-600 rounded flex items-center justify-center group hover:bg-blue-700 transition-all duration-200 ease-in-out hover:scale-105 gap-1 flex-row"
            target="_blank"
