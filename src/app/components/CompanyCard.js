...
export default function CompanyCard({ company }) {
    return (
        <a className="flex justify-center items-center hover:-translate-y-1.5 transition ease-in-out duration-150" href={`/company/${company.siren}`} key={`${company.siren}-${company.siege.siret}`}>
