...
export default function CompanyCard({ company }) {
    ...
    return (
        <a aria-label={`card of company ${company.nom_raison_sociale}`} className="max-w-80 flex justify-center flex-col hover:-translate-y-1.5 transition ease-in-out duration-150" href={`/company/${company.siren}`}>
            ...
            <div className="bg-gray-200 hover:bg-gray-300 transition ease-in-out duration-150 rounded-lg rounded-tl-none w-full h-48 px-3 pt-5">
                <CompanyNameCardInfo name={company.nom_raison_sociale} />
