...
export default function CompanyPhysicBossCard({ dirigeant }) {
    ...
    return (
        <div className="hover:bg-gray-400 hover:-translate-y-2 transition ease-in-out duration-150 bg-gray-300 p-2 max-w-80 h-36 rounded-lg">
            ...
            <div className="flex justify-center flex-col gap-1">
                ...
                <p className="ttext-ellipsis overflow-hidden whitespace-nowrap text-xs" title={dirigeant.qualite}>{`Qualité: ${dirigeant.qualite}`}</p>
            </div>
        </div>
    );
}
