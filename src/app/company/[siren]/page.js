...
import { FaLocationDot, FaPeopleGroup, FaBuilding, FaCakeCandles, FaArrowLeft, FaHandHoldingDollar, FaHandHoldingHeart } from "react-icons/fa6";
                        ...
                        return (
                            <div className="flex justify-center flex-col gap-5 items-center" key={company.siren + "-" + company.siege.siret}>
                                <div className="flex justify-center flex-col gap-3 w-4/5 bg-gray-300 rounded p-5">
                                    ...
                                    <p className="flex flex-row items-center text-xl gap-1">
                                        <FaCakeCandles /> {company.date_creation ?? unknownString}
                                    </p>
                                    <p className="flex flex-row items-center text-xl gap-1">
                                        {company.complements.est_association ? (
                                            <>
                                                <FaHandHoldingHeart /> Est une association
                                            </>
                                        ) : (
                                            <>
                                                <FaHandHoldingDollar /> N&apos;est pas une association
                                            </>
                                        )}
                                    </p>
                                </div>
